...
const { generateAndStoreToken } = require('../verification/codeGeneration');
const { handleVerification } = require('../verification/codeVerification');
...
function generateVerificationEmailContent(verificationCode) {
    ...
    const content = `<p>Your verification code is: <b>${verificationCode}</b></p>`;
